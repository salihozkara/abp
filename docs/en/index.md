...
//[doc-seo]
{
    "Description": "Explore the ABP Documentation to learn how to build enterprise software with best practices on .NET and ASP.NET Core, featuring guides, templates, and tools for efficient development."
}
```
