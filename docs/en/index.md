...
//[doc-seo]
{
    "Description": "Explore ABP's documentation to learn how to build enterprise applications with .NET and ASP.NET Core, leveraging best practices and ready-to-use solutions."
}
```
