...
//[doc-seo]
{
    "Description": "Discover how to create new ABP solutions with sample commands using the ABP CLI. Learn about project setups, mobile options, and database providers to kickstart your development!"
}
```
